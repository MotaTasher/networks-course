...
1) Эмулятор работы RIP с выводом промежуточных результатов
2) Измерение скорости и количества теряющихся пакетов по udp/tcp
...
<img src="images/1.2.png" width=320 />

<img src="images/1.3.png" width=334 />
