...
TLDR: 
1) реализовал трассировку маршрута на основе пакетов с ICMP (с подсписью промежуточных пунктов)
2) Реализовал дистанционно-векторную маршрутизацию на основе общения отдельных потоков
3) Отправил первые сообщения используя ipv6
...
<img src="images/3.1.png" width=1000 />
<img src="images/3.2.png" width=1000 />

Как видно, мы установили соединение через IPv6
